  ...
  Widget build(BuildContext context) {
    return controller.obx((state) => Scaffold(
      appBar: AppBar(
        ...
        title: Row(
          children: [
            SizedBox(width: Get.width/5.5,),
            const Text("Home", style: TextStyle(fontSize: 22,fontWeight:
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  const Padding(
                    ...
                    child: Text("Please select Trade", style: TextStyle(),),
                  ):Padding(
                    padding: const EdgeInsets.all(10),
                    child: Text(controller.selectedValue.toString(),style:
            ...
            child: InputDecorator(
              ...
              child: DropdownButtonHideUnderline(
                child: DropdownButton<String>(
                  ...
                  const Padding(
                    padding: EdgeInsets.all(10),
                    child: Text("Please select Station", style: TextStyle(),),
                  ):Padding(
                    padding: const EdgeInsets.all(10),
                    child: Text(controller.selectedValue2.toString(),style:
                    const TextStyle(fontSize: 16,color: Colors.black),),
                  ),
                  isExpanded: true,
          ...
          GestureDetector(
            ...
            child:   Center(
              child: Container(
                ...
                child: const Center(child: Text("Add Data",style: TextStyle(color: Colors.white),)),
              ),
            ),
